...
export const metadata: Metadata = {
  ...
  description: "Platform digital survei Perilaku Hidup Bersih dan Sehat (PHBS) Kabupaten Malang. Mendukung 39 Puskesmas, 390 desa, dengan teknologi offline-first PWA.",
