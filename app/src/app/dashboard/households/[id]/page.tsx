...
export default async function DashboardHouseholdDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="bg-white border-b border-gray-200 px-6 py-4 flex items-center gap-4">
        <Link href="/dashboard/households" className="text-gray-400 hover:text-gray-600">
      ...
      <div className="p-6 max-w-3xl mx-auto space-y-6">
            ...
            <div className="space-y-3">
              {members.map(m => (
                <div key={m.id} className="p-3 border border-gray-100 rounded-xl bg-gray-50 flex justify-between items-center">
                  ...
                  <Link 
                    href={`/dashboard/households/${id}/members/${m.id}/edit`}
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
          ...
          <SurveyHistoryList surveys={surveys || []} basePath="/dashboard" />
        </div>
      </div>
    </div>
  )
